...
public class XMLLexiconTest {
    ...
    public void setUp() {
        ...
        // lexicon instead
        this.lexicon = new simplenlg.lexicon.catalan.XMLLexicon();
    ...
    public void xmlLexiconImmutabilityTest() {
        ...
        // "wall" is singular.
        NPPhraseSpec pared = factory.createNounPhrase("la", "paret");
        Assert.assertEquals(NumberAgreement.SINGULAR, pared.getFeature(Feature.NUMBER));

        // Realise a sentence with plural form of "wall"
        pared.setPlural(true);
        SPhraseSpec sentence = factory.createClause("moviment", "observar");
        sentence.setFeature(Feature.TENSE, Tense.PAST);
        PPPhraseSpec pp = factory.createPrepositionPhrase("a", pared);
        ...
        pared = factory.createNounPhrase("la", "paret");
        Assert.assertEquals(NumberAgreement.SINGULAR, pared.getFeature(Feature.NUMBER));
    }
