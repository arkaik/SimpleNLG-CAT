...
public class SharedLexiconTests {
    ...
    public void doBasicTests(Lexicon lexicon) {
        ...
        // trees
        Assert.assertEquals(3, lexicon.getWords("poder").size());
        ...
        WordElement bueno = lexicon.getWord("bo", LexicalCategory.ADJECTIVE);
        Assert.assertEquals("millor", bueno
                .getFeatureAsString(LexicalFeature.COMPARATIVE));
        Assert.assertEquals("boníssim", bueno
        ...
        Assert.assertEquals("dones", mujer
        ...
        WordElement arena = lexicon.getWord("sorra", LexicalCategory.NOUN);
        ...
        // test hasWord
        Assert.assertEquals(true, lexicon.hasWord("arbre")); // "tree" exists
        Assert.assertEquals(false, lexicon.hasWord("arbre",
        ...
        WordElement comer = lexicon.getWordFromVariant("menjant");
        Assert.assertEquals("menjar", comer.getBaseForm());
        ...
        Assert.assertEquals("sigut", lexicon.getWordFromVariant("ésser",
