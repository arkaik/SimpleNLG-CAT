...
public class HTMLFormatterTest extends SimpleNLG4Test {
    ...
    public final void testWebPageContent() {
        ...
        DocumentElement document = phraseFactory.createDocument("Esto es un título");

        DocumentElement section = phraseFactory.createSection("Esto es una sección");

        DocumentElement paragraph1 = phraseFactory.createParagraph();
        DocumentElement sentence11 = phraseFactory.createSentence("Esta es la primera oración del párrafo 1");
        paragraph1.addComponent(sentence11);
        DocumentElement sentence12 = phraseFactory.createSentence("Esta es la segunda oración del párrafo 1");
        ...
        DocumentElement sentence2 = phraseFactory.createSentence("Esta es la primera oración del párrafo 2");
        ...
        DocumentElement sentence3 = phraseFactory.createSentence("Esta es la primera oración del párrafo 3");
        ...
        SPhraseSpec p1 = phraseFactory.createClause("Mary", "perseguir", "el mono");
        SPhraseSpec p2 = phraseFactory.createClause("el mono", "pelear");
        ...
        DocumentElement sectionList = phraseFactory.createSection("Esta sección contiene listas");
        ...
        String expectedResults =
                "<h1>Esto es un título</h1>" +
                        ...
                        "<p>Esta es la primera oración del párrafo 1. Esta es la segunda oración del párrafo 1.</p>" +
                        "<p>Esta es la primera oración del párrafo 2.</p>" +
                        "<p>Esta es la primera oración del párrafo 3.</p>" +
                        "<h2>Esta sección contiene listas</h2>" +
                        "<p>Mary persigue el mono. El mono pelea. Mary está nerviosa.</p>" +
                        "<ul>" +
                        "<li>Item 1</li>" +
                        "<li>Item 2</li>" +
                        "<li>Item 3</li>" +
