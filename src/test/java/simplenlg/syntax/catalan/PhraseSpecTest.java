...
public class PhraseSpecTest extends SimpleNLG4Test {
    ...
    public void testSPhraseSpec() {
        ...
        c2.setVerb("veure");
        c2.setSubject("l'home");
        c2.setObject("jo");
        c2.addFrontModifier("afortunadament");
        c2.addModifier("ràpidament");
