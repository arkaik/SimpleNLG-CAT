 ...
 */
package simplenlg.lexicon.catalan;
...
public class XMLLexicon extends simplenlg.lexicon.XMLLexicon {
    ...
    public XMLLexicon(String filename) {
        ...
        super(filename, Language.CATALAN);
        this.PLURAL_COORDINATORS.addAll(Arrays.asList("i", "o"));
    }
    ...
    public XMLLexicon(URI lexiconURI) {
        ...
        super(lexiconURI, Language.CATALAN);
        this.PLURAL_COORDINATORS.addAll(Arrays.asList("i", "o"));
    }

    public XMLLexicon() {

        super(Language.CATALAN);
        this.PLURAL_COORDINATORS.addAll(Arrays.asList("i", "o"));
    }
        ...
        if (category instanceof LexicalCategory) {
            switch ((LexicalCategory) category) {
                case NOUN:
                    ...
                    variants.add(getVariant(word, LexicalFeature.FEMININE_PLURAL, "es"));
                    break;
...
//                    variants.add(getVariant(word, LexicalFeature.COMPARATIVE, "er"));
                    variants.add(getVariant(word, LexicalFeature.SUPERLATIVE, "íssim"));
                    variants.add(getVariant(word, LexicalFeature.SUPERLATIVE_FEMININE, "íssima"));
                    variants.add(getVariant(word, LexicalFeature.SUPERLATIVE_FEMININE_PLURAL, "íssimes"));
                    break;

                case VERB:
                    variants.add(getVariant(word, LexicalFeature.PAST_PARTICIPLE, "t"));
                    variants.add(getVariant(word, LexicalFeature.PRESENT_PARTICIPLE, "nt"));
    ...
    public WordElement getAdditionCoordConjunction() {
        return lookupWord("i", LexicalCategory.CONJUNCTION);
    }
    ...
    public WordElement getPassivePreposition() {
        return lookupWord("per", LexicalCategory.PREPOSITION);
    }
