...
public class MorphologyRules extends simplenlg.morphology.MorphologyRules {
    ...
    public NLGElement doVerbMorphology(InflectedWordElement element, WordElement baseWord) {
        ...
        if (element.getFeatureAsBoolean(Feature.NEGATED) || Form.BARE_INFINITIVE.equals(formValue)) {
            ...
            if (Form.PAST_PARTICIPLE.equals(formValue)) {
                ...
                || Person.THIRD.equals(
                personValue)) && (tenseValue == null || Tense.PRESENT.equals(tenseValue))) {
     ...
     * @return the inflected word.
     */
    private String buildDoublePastVerb(String baseForm) {
        String morphology = null;
        if (baseForm != null) {
     ...
     * @return the inflected word.
     */
    private String buildDoublePresPartVerb(String baseForm) {
        String morphology = null;
        if (baseForm != null) {
    ...
    public NLGElement doDeterminerMorphology(InflectedWordElement element) {
        NLGElement realisedElement = new StringElement(element.getBaseForm(), element);
        realisedElement.setFeature(InternalFeature.DISCOURSE_FUNCTION,
                element.getFeature(InternalFeature.DISCOURSE_FUNCTION));
        return realisedElement;
    }
