 ...
 * @version 4.0
 */
public class SyntaxProcessor extends simplenlg.syntax.SyntaxProcessor {

    @Override
    public void initialise() {
        this.clauseHelper = new ClauseHelper();
        this.coordinatedPhraseHelper = new CoordinatedPhraseHelper();
